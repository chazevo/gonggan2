...
<script type="text/javascript">
	...
	window.onload = function() {
		...
		$(".review").css('background-color', '#E6E6E6'); 
		...
		<!-- container-fluid : 화면 너비가 resize 되더라도 화면에 가득 참  -->
			...
			<div class="collapse navbar-collapse" id="menu">
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li>
						<a class="review" href="javascript:$('#listbody').html(''); requestCategoryList(category = 'review', rownum=1);"
					...
					<li>
						<a href="movie_review.do?writer_id=${param.writer_id }">
					...
					<li>
						<a href="myhome_book.do?writer_id=${param.writer_id }">
