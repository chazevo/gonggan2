<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"
	import="java.util.Calendar, com.kh.gonggan.member.model.vo.Member, com.kh.gonggan.blog.model.vo.Blog"%>
	...
	<div class="divCenter">
		<nav class="navbarCustom navbar-default">
			<div class="navbar-header">
				<a class="navbar-brand" href="index.jsp"> <img class=""
					src="images/KakaoTalk_Photo_2017-04-22-23-02-45.png" width="70px">
					<img class="" src="images/KakaoTalk_Photo_2017-04-22-18-18-54.png"
					width="70px"></a>
			</div>
			<div class="navbar-right navbar-brand">
				<c:if test="${empty sessionScope.loginUser }">
					<a class="loginbox" href="index.jsp"> l o g i n </a>
				</c:if>
				<c:if test="${!empty sessionScope.loginUser }">
					<a id="loginUser" class="navbar-brand"> <img
						src="images/default.png" height="40px" class="img-circle">&nbsp;
		...
		<div id="loginUserDetail" class="hidden">
			<table id="idclick_table">
				...
				<tr>
					<td>알림&nbsp; <img src="images/idclick_new_icon.png"
						id="idclick_new_icon">
					</td>
				</tr>
				<!-- <tr>
				...
				<tr>
					<td class="hover">${param.writer_id }님의알림이 없습니다.</td>
				</tr>
			</table>
		</div>
		...
		<div>
			...
			<div class="header-content">
				<div class="header-content-inner">
					<h2>
						<a href="start.do">당신만의 공간에서 당신의 글을 만들어보세요.</a>
					</h2>
				</div>
				<div class="header-content-inner2">
					<a href="controll.do"> <img class="smallIcon"
			...
			<div class="navbar-header idView">
				...
				<a href="#" style="display: inline-block"> <img
					...
					data-src="/gonggan/messageList.do?memberId1=${sessionScope.loginUser.getMember_id()}&memberId2=jis"><img
					src="images/chat_icon.png" height="28px" id="chat_icon"></a>
			</div>
				...
				<div>
					...
					-->
						...
						<table width="100%">
							<tr>
								<th class="th"><c:if
										test="${sessionScope.loginUser.getMember_id() eq param.userId}}">
										<a href="uploadform.do">포스트 쓰기 </a>
									</c:if> <label class='radio-wrap'> <input type='radio'
										name='listType' id='calendar' onclick='requestList();' checked>
										<i class='calendar-icon'></i>
								</label> <label class='radio-wrap'> <input type='radio'
										name='listType' id='list' onclick='requestList();'> <i
										class='list-icon'></i>
								</label></th>
							</tr>
							<tr id="todayHeader">
								<td>
									<h3 class="section-heading text-center" style="color: #E6E6E6;">
										<span id="year"></span>.<span id="month"></span>.<span
											id="today"></span>
									</h3>
								</td>
							</tr>
						...
						<div id="dotdotdotDiv">
							<a class="hover dotdotdot" href="">부적절한 컨텐츠 신고</a> <a
								class="hover dotdotdot" href="">공유</a> <a
								class="hover dotdotdot" href="">쪽지 보내기</a>
						</div>
					</div>
				</div>
			</div>
