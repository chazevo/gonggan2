		...
		<div>
			...
			<div class="navbar-header">
				...
				<a class="" href="#"> <img class=""
					src="images/KakaoTalk_Photo_2017-04-22-23-02-45.png" width="70px">
					<img class="smallLogoImg"
					src="images/KakaoTalk_Photo_2017-04-22-18-18-54.png" width="70px"></a>
			</div>
	...
	<div class="divCenter">
		...
		<div class="blogHomeHeader">
			<table class="table1st">
				...
				<tr>
					<td class="disapear"><img
						src="images/KakaoTalk_Photo_2017-04-26-10-19-25.png" width="100%">
					</td>
					<td class="table2nd">
						<table>
							<colgroup>
							...
							<tbody id="listbody_newPost">
								<tr>
									<td><a href="">꼼지락이주부 감성 DIY 셀프인테리어</a> | <a href=""><font
											color="#2D86C9">꼼지락이 주부</font></a></td>
									<td></td>
								</tr>
								<tr>
									<td><a href="">동갑내기 부부의 세계로 가는 자전거 여행</a> | <a href=""><font
											color="#2D86C9">이대장</font></a></td>
									<td></td>
								</tr>
								<tr>
									<td><a href="">토리와 함께 추억쌓기 놀이</a> | <a href=""><font
											color="#2D86C9">긍정의아이콘 토리 </font></a></td>
									<td></td>
								</tr>
								<tr>
									<td><a href="">행복가득한 그루터기 발자취</a> | <a href=""><font
											color="#2D86C9">그루터기</font></a></td>
									<td></td>
								</tr>
								<tr>
									<td><a href="">진격의 깐깐징어 깐깐징어 깐징어 우아우아.......</a> | <a
										href=""><font color="#2D86C9">깐깐징어</font></a></td>
									<td></td>
								</tr>
							</tbody>
							<tr>
								<td colspan="2" align="center"><img width="98%"
									height="2px"
									src="images/KakaoTalk_Photo_2017-04-26-10-46-42_84.png">
								</td>
							</tr>
							<tr>
								<td>서로이웃 신청_ <font color="#2D86C9"> <b
										id="neighborReqListSize">${neighborReqListSize }</b>
								</font>
								</td>
								<td><a href="">▶</a></td>
							</tr>
											...
											<tr>
												<c:if test="${!empty (neighborReqList) }">
													<c:forEach items="${ neighborReqList}" var="i" begin="0">
														<td><a href="selectBlog.do?writer_id=${i.member_id }">${i.member_id }</a>
															<a
															href="javascript:acceptNeig('${sessionScope.loginUser.getMember_id() }', '${i.member_id }');">
																<div class="neighborYN">수락</div>
														</a> <a
															href="javascript:rejectNeig('${sessionScope.loginUser.getMember_id() }', '${i.member_id }');">
			...
			<div class="myDiv">
				...
				%>
				<%=loginUser.getMember_name()%>님 <a href="/gonggan/logOut.do">로그아웃</a>
				<!-- <a href="/gonggan/update.do">정보수정</a> -->
				<hr class="whiteHr">
				<b><a href="/gonggan/mypage.do">내 블로그 소식</a></b> <a href="">나의
					흔적</a>
				<!-- 내가 쓴 댓글들  -->
				<a href="">이웃 블로그</a>
				<!-- 이웃 블로그 목록, 이웃 새글 -->
				<a href="uploadform.do">포스트 쓰기</a> <a
					href="selectBlog.do?writer_id=${sessionScope.loginUser.getMember_id() }"><div
						class="goToMyBlog">내 블로그</div></a> <img
					src="images/KakaoTalk_Photo_2017-04-26-10-24-13.png" width="50px">
				<%
					}
				%>
			</div>
						...
						<tr>
							...
							<td>
								<div class="div2">
									...
									<a href="#"> <img
										src=images/KakaoTalk_Photo_2017-04-26-21-33-40_100.png
										width="10%">
									</a>
								</div>
							</td>
