...
<script type="text/javascript">
	...
	$('#nl1').click(function() { $('#naver_id_login').click(); });
	$('#ttt').click(function() { $("#naver_id_login").trigger("click"); });
	$('#klb').click(function() { $('#nl1').click(); });
	$('#flb').click(function() { $('#nl1').click(); });
	...
	<header>
		<div class="header-content" id="indexBg">
			<div class="header-content-inner">
				...
				<a href="", id = "nl1"><img src="images/naver.png" alt="Naver Login" width="15" height="15"></a>  
				<input type="button" id="ttt">
