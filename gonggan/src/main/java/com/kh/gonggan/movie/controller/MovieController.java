...
public class MovieController {
	...
	@RequestMapping(value="/moviesearch.do", produces={"application/json"}, method=RequestMethod.GET)
	public ModelAndView searchMovie(ModelAndView mv, @RequestParam String keyword, HttpSession session){
		...
		List<Movie> result = ((Post) gson.fromJson(response_.toString(), type)).getItems();
		for (Movie m : result)  {
